...
readonly EXPERIMENT_ROOT="${ARTIFACT_ROOT}/evaluation/vehiclemembench/recursive-summary-patch-s1-s10-20260812-retry-1"
...
echo "[$(date --iso-8601=seconds)] Recursive Summary Patch S1-10 started"
