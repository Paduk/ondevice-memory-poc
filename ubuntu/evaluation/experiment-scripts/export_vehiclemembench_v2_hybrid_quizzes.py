#!/usr/bin/env python3
"""Export normalized Hybrid V2 Turn/Final Quiz JSONL."""
...
from palmclaw_ubuntu.vehicle_bench.v2_quiz_export import export_quiz_views
...
def main() -> int:
    ...
    manifest = export_quiz_views(
        ...
        training_manifest_path=output_root / "manifest.json",
    )
