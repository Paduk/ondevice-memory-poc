...
readonly EXPERIMENT_ROOT="${ARTIFACT_ROOT}/evaluation/vehiclemembench/turnwise-smoke-s6-50-${SLUG}-r3-20260813"
...
echo "[$(date --iso-8601=seconds)] ${PROFILE} 50-turn smoke started"
...
if [[ ${status} -eq 0 ]]; then
  ...
  echo "[$(date --iso-8601=seconds)] ${PROFILE} 50-turn smoke completed"
else
