...
readonly RUN_ROOT="/mnt/data/hj153lee/PalmClaw/evaluation/vehiclemembench-v2-hybrid/hybrid-scale-s51-s100-state-evolution-r1"
...
failed=0
active=0
scenario_indexes=($(seq 51 100))
printf '[%s] S51-S100 state-evolution controller started (parallel=%d)\n' \
  "$(date -u +%FT%TZ)" "$MAX_PARALLEL"
