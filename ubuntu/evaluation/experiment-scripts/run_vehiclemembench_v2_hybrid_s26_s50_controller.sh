...
readonly RUN_ROOT="/mnt/data/hj153lee/PalmClaw/evaluation/vehiclemembench-v2-hybrid/hybrid-scale-s26-s50-state-evolution-r1"
...
failed=0
active=0
scenario_indexes=($(seq 26 50))
printf '[%s] S26-S50 state-evolution controller started (parallel=%d)\n' \
