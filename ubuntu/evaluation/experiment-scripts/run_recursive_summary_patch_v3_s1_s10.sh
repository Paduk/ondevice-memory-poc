...
readonly EXPERIMENT_ROOT="${ARTIFACT_ROOT}/evaluation/vehiclemembench/recursive-summary-patch-v3-v1prompt-s1-s10-20260812"
...
echo "[$(date --iso-8601=seconds)] Recursive Summary Patch v3 (v1 prompt) S1-10 started"
