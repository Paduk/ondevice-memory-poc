...
workspace="/mnt/data/hj153lee/PalmClaw/on-device-memory-training-temporal-eval-t18-t20"
run_root="${main_workspace}/runs/qwen35-4b-patch-multitask-noop5-r1"
checkpoint="${run_root}/checkpoints/epoch-04"
data_root="/mnt/data/hj153lee/PalmClaw/evaluation/vehiclemembench-v2-temporal/patch-noop5-eval-t18-t20/data"
output_dir="${run_root}/test-hf-temporal-t18-t20-epoch04"
