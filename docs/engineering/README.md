...
- [Compact A-MEM-style plan](compact-amem-style-implementation-plan.md): resource-matched episode compaction, deterministic linking, conflict-gated evolution, and four short implementation checkpoints.
